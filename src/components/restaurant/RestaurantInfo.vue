<template>
  <div class="restaurant-info">
    ...
    <p v-if="restaurant.address" class="text-muted pl-4">
      ...
      <span class="badge badge-light rounded-pill" data-toggle="modal" data-target="#restaurantDetail" role="button">More info</span>
    </p>

      <!-- Modal -->
  <div  :key="restaurant.restaurantId" class="modal fade"
      id="restaurantDetail" tabindex="-1" role="dialog" aria-labelledby="restaurantDetailTitle" aria-hidden="true">
